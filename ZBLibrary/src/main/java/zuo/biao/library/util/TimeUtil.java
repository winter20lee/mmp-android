...
public class TimeUtil {
	...
	public static String getTime(long date) {
		return new SimpleDateFormat("mm:ss").format(new Date(date));
	}
	 ...
	 * @return
	 */
	public static String getTime(long date,String danwei) {
		return new SimpleDateFormat("mm:ss").format(new Date(date))+" "+danwei;
	}
