...
public interface FragmentPresenter extends Presenter {
	static final String CLASSIFICATION_SEARCH_KEYWORD = "CLASSIFICATION_SEARCH_KEYWORD";
	static final String CLASSIFICATION_SEARCH_TYPE = "CLASSIFICATION_SEARCH_TYPE";
	static final String CLASSIFICATION_SEARCH_TYPE_LOOT = "LOOT";
	static final String CLASSIFICATION_SEARCH_TYPE_MALL = "MALL";
