...
public class Cache<T> {
	...
	public void save(String key, T value) {
		...
		sp.edit().remove(key).putString(key, GsonUtil.GsonString(value)).commit();
	}
	...
	public T get(String key) {
		...
		return GsonUtil.GsonToBean(sp.getString(StringUtil.getTrimedString(key), null), clazz);
	}
	...
	public List<T> getAllValueList() {
		...
		if (map != null) {
			...
			for (String value : map.values()) {
				data = GsonUtil.GsonToBean(value, clazz);
				if (data != null) {
					list.add(data);
				}
			}
